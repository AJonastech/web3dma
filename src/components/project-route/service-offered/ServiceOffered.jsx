    ...
    >
      ...
      <div className="relative w-full  mt-[200px] ">
        <img
          ...
          className="lg:absolute lg:max-w-[350px] lg:rounded-[40px] xl:max-w-[450px] h-full  w-full lg:h-[70%] xl:h-[80%] lg:top-[50%] lg:-translate-y-[50%]  object-cover object-center    -top-[50px] lg:mt-0 mt-[-100px] mb-10 lg:mb-0 left-[50px] z-20 mx-auto "
        />
