...
function ClientTestimonial() {
  ...
  return (
    ...
    className="max-w-[600px]  sm:px-4 text-white text-left  font-dmsans text-base sm:text-lg lg:text-xl  sm:text-left leading-snug sm:leading-normal md:leading-relaxed"
    viewport={{once:true}}
>
    {
