...
function ContactView() {
    ...
    >
      ...
      <div className="max-w-[1029px] mx-auto">
        ...
        <AnimateHeader type={"left"} className="font-poppins text-white uppercase font-semibold text-3xl lg:leading-[44.08px] lg:text-[39.8px] tracking-[-2%]" text={"Get in touch"} delay={0.15}/>
       <AnimateHeader text={"With us now"} type={"left"} delay={0.25} className={"absolute top-8 font-poppins text-white text-cener uppercase font-extrabold text-5xl lg:leading-[66.19px] lg:text-[59.77px] tracking-[-2%]"}/>
        </div>
        <motion.form viewport={{once:true}}  initial={{ y:200}} transition={{delay:0.2, ease:easeOut}} whileInView={{y:0}} onSubmit={(e)=>{e.preventDefault()}} className="grid grid-cols-1  mt-[20px]  relative">
