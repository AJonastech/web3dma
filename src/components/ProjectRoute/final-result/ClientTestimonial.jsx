...
function ClientTestimonial() {
  ...
  return (
    <motion.div
      ...
      whileInView={{ y: 0 }}
      className=" w-full relative  flex flex-col gap-y-10 items-center px-5  justify-center min-h-[60vh] h-[60vh] bg-[#111141]"
    >
      <blockquote className="flex relative lg:-mt-[20px] font-medium text-center lg:w-[70%] w-[90%] mx-auto  text-base lg:text-xl lg:leading-[40px]">
        <img
          src={"/quote-left.svg"}
