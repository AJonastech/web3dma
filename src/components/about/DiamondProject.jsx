...
function DiamondProject({ diamondProject }) {
  return (
    <motion.div
      ...
      style={{ backgroundImage: `url(${diamondProject.url})`  }}
      className=" cursor-pointer bg-cover  bg-no-repeat bg-center w-full h-[419px] px-[26px] py-[29px] space-y-[18px] rounded-md"
    >
