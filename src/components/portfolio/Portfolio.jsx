    ...
    <section id="projects" className="w-full snap-center relative">
      <section className="container mt-[100px] lg:mt-[80px] mx-auto  bg-blend-soft-light bg-inherit text-[#fff]">
        ...
        <section className="container   mx-auto lg:py-[160px]  text-white  px-3 lg:px-12 relative">
          ...
          <AnimateHeader delay={0.} text={"See Our"} className={"font-poppins text-white z-20 text-center uppercase text-3xl lg:text-[37.96px] lg:leading-[42.04px] font-semibold "}/>
          <AnimateHeader delay={0.1} text={"Recent"} size={"large"} className={"font-poppins text-white z-20 text-center uppercase text-7xl absolute top-6  lg:text-[94.23px] lg:leading-[104.36px] font-extrabold"} />
          <AnimateHeader delay={0.2}  text={"Projects"} className={"font-poppins text-white z-20 text-center uppercase text-5xl  mt-12 lg:mt-16  lg:leading-[56.66px] font-bold"}/>
